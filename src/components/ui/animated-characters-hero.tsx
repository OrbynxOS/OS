...
export interface AnimatedCharactersHeroProps {
  password?: string;
...
export function AnimatedCharactersHero({
  password = "",
  showPassword = false,
  isTyping = false,
  brandName = "OrbynexOS",
}: AnimatedCharactersHeroProps) {
  const [mouseX, setMouseX] = useState(0);
  const [mouseY, setMouseY] = useState(0);
  ...
  const reactingToInput = isTyping || passwordHidden;

  return (
    <section
      className="relative hidden flex-1 flex-col justify-between bg-gradient-to-br from-primary/90 via-primary to-primary/80 p-12 text-primary-foreground md:flex"
      aria-label="Animated characters"
    >
        ...
        <div className="relative" style={{ width: "550px", height: "400px" }}>
          <div
            ...
            style={{
              left: "70px",
              width: "180px",
              height: reactingToInput ? "440px" : "400px",
